$(function () {
    ...
    $(".mil-menu-btn").on("click", function () {
        ...
        $(window).on("scroll", function () {
            $(window).scrollTop() >= 220 ? ($(".mil-top-panel.mil-animated").removeClass("mil-top-panel-transparent"),
                $(".has-additional-panel").addClass("mil-hide-top")) : ($(".mil-top-panel.mil-animated").addClass("mil-top-panel-transparent"),
